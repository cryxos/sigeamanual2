...
DR_EXPLAIN.data_menu = {
    // menu
    DREX_NODE_NAMES: ["Página principal","Tabla de contenidos","1. Guía de Usuario","2. Pasos para Registradores","3. Pasos para SIAR","4. Videos de ayuda","1.1. Acceso al Sistema","1.2. Búsqueda por palabras en el título, descripción, objetivos, limitaciones.","1.3. Búsqueda según el Marco Ordenador","1.4. Búsqueda según Entidad registradora de información","1.5. Búsqueda según Ubicación Territorial","1.6. Consulta de Estadísticas","1.7. Intranet","1.8. Registro de variables / Indicadores","1.9. Mensajes","1.10. Control de procesos","a. Iniciar sesión","b. Ingresar al módulo variables / indicadores","c. Registrar una variable / indicador","d. Configurar el contenido de una variable / indicador","e. Registrar ficha Técnica","f. Agregar descriptores","g. Solicitar revisión de la ficha técnica","h. Registar datos para la variable / indicador","1.7.1. Acceso al Intranet"],
    DREX_NODE_LINKS: ["index.htm","tabla_de_contenidos.htm","guia_de_usuario.htm","2__pasos_para_registradores.htm","3__pasos_para_siar.htm","videos_de_ayuda.htm","acceso_al_sistema.htm","busqueda_por_palabras_en_el_titulo__descripcion__objetivos__limitaciones_.htm","busqueda_segun_el_marco_ordenador.htm","busqueda_segun_entidad_registradora_de_informacion.htm","busqueda_segun_ubicacion_territorial.htm","consulta_de_estadisticas.htm","intranet.htm","registro_de_variables___indicadores.htm","mensajes.htm","control_de_procesos.htm","a__iniciar_sesion.htm","b__ingresar_al_modulo_variables___indicadores.htm","c__registrar_una_variable___indicador.htm","d__configurar_el_contenido_de_una_variable___indicador.htm","e__registrar_ficha_tecnica.htm","f__agregar_descriptores.htm","g__solicitar_revision_de_la_ficha_tecnica.htm","h__registar_datos_para_la_variable___indicador.htm","acceso_al_intranet.htm"],
    DREX_NODE_CHILD_START: [1,6,6,16,24,24,24,24,24,24,24,24,24,25,25,25,25,25,25,25,25,25,25,25,25],
    DREX_NODE_CHILD_END: [6,6,16,24,24,24,24,24,24,24,24,24,25,25,25,25,25,25,25,25,25,25,25,25,25],
    DREX_MENU_TYPE: 2,
